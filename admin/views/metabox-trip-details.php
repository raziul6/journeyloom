...
<?php // The AI Trip Builder is added by the Pro add-on as a separate metabox. ?>
<div class="wptm-panel-intro">
    <span class="dashicons dashicons-info-outline"></span>
    <p><?php esc_html_e( 'Key facts about this trip — shown in the summary box and search filters.', 'byteflows-travel-hotel-booking' ); ?></p>
</div>
<div class="wptm-meta-field" style="margin-bottom:16px;">
    <label style="display:flex;align-items:center;gap:8px;cursor:pointer;">
        ...
        <strong><?php esc_html_e( 'Featured trip', 'byteflows-travel-hotel-booking' ); ?></strong>
    </label>
    <p class="description"><?php esc_html_e( 'Show a “Featured” ribbon on this trip’s card across listings.', 'byteflows-travel-hotel-booking' ); ?></p>
</div>
<div class="wptm-meta-grid">
    <div class="wptm-meta-field">
        <label><?php esc_html_e( 'Duration', 'byteflows-travel-hotel-booking' ); ?></label>
    ...
    <div class="wptm-meta-field">
        <label><?php esc_html_e( 'Group Size', 'byteflows-travel-hotel-booking' ); ?></label>
        <div class="wptm-inline">
            <input type="number" name="wptm_group_min" value="<?php echo esc_attr( $fields['group_min'] ); ?>" min="1" placeholder="<?php esc_attr_e( 'Min', 'byteflows-travel-hotel-booking' ); ?>">
            <span class="wptm-inline__sep">—</span>
            <input type="number" name="wptm_group_max" value="<?php echo esc_attr( $fields['group_max'] ); ?>" min="1" placeholder="<?php esc_attr_e( 'Max', 'byteflows-travel-hotel-booking' ); ?>">
        </div>
    </div>
    <div class="wptm-meta-field">
    ...
    <div class="wptm-meta-field">
        <label><?php esc_html_e( 'Minimum Age', 'byteflows-travel-hotel-booking' ); ?></label>
        ...
        <div class="wptm-repeater wptm-list-repeater">
            ...
            <div class="wptm-repeater-items">
                ...
                <div class="wptm-repeater-item"><div class="wptm-list-row">
                    ...
                    <button type="button" class="wptm-remove-item button-link" aria-label="<?php esc_attr_e( 'Remove', 'byteflows-travel-hotel-booking' ); ?>"><span class="dashicons dashicons-trash"></span></button>
                </div></div>
                <?php endforeach; ?>
            </div>
    ...
    <div class="wptm-meta-field wptm-full">
        <label><?php esc_html_e( 'Highlights', 'byteflows-travel-hotel-booking' ); ?></label>
        <?php $wptm_list_repeater( 'wptm_highlights', wptm_to_list( $fields['highlights'] ), __( 'e.g. Sunset over the valley', 'byteflows-travel-hotel-booking' ), __( 'Add Highlight', 'byteflows-travel-hotel-booking' ) ); ?>
    </div>
    <div class="wptm-meta-field wptm-full">
        <label><?php esc_html_e( "What's Included", 'byteflows-travel-hotel-booking' ); ?></label>
        <?php $wptm_list_repeater( 'wptm_includes', wptm_to_list( $fields['includes'] ), __( 'e.g. Airport transfers', 'byteflows-travel-hotel-booking' ), __( 'Add Item', 'byteflows-travel-hotel-booking' ) ); ?>
    </div>
    <div class="wptm-meta-field wptm-full">
        <label><?php esc_html_e( "What's Excluded", 'byteflows-travel-hotel-booking' ); ?></label>
        <?php $wptm_list_repeater( 'wptm_excludes', wptm_to_list( $fields['excludes'] ), __( 'e.g. International flights', 'byteflows-travel-hotel-booking' ), __( 'Add Item', 'byteflows-travel-hotel-booking' ) ); ?>
    </div>
</div>
