...
<?php if ( wptm_is_pro() && get_option( 'wptm_enable_ai' ) ) :
    ...
    <div class="wptm-ai-builder" id="wptm-ai-builder">
        <div class="wptm-ai-builder__head">
            ...
            <div>
                <strong><?php esc_html_e( 'AI Trip Builder', 'journeyloom' ); ?></strong>
                <span><?php esc_html_e( 'Generate the full trip — description, highlights, itinerary, inclusions & FAQ — in one click.', 'journeyloom' ); ?></span>
            </div>
        </div>
        <div class="wptm-ai-builder__grid">
            <label class="wptm-ai-field wptm-ai-field--wide">
                <span><?php esc_html_e( 'Destination', 'journeyloom' ); ?></span>
                <input type="text" class="wptm-ai-dest" value="<?php echo esc_attr( $ai_dest ); ?>" placeholder="<?php esc_attr_e( 'e.g. Bali, Indonesia', 'journeyloom' ); ?>">
            </label>
            <label class="wptm-ai-field">
                <span><?php esc_html_e( 'Days', 'journeyloom' ); ?></span>
                <input type="number" class="wptm-ai-days" value="<?php echo esc_attr( $ai_days ); ?>" min="1" max="30">
            </label>
            <label class="wptm-ai-field">
                <span><?php esc_html_e( 'Style', 'journeyloom' ); ?></span>
            ...
            <label class="wptm-ai-field">
                <span><?php esc_html_e( 'Budget', 'journeyloom' ); ?></span>
                <select class="wptm-ai-budget">
                    <option value="budget"><?php esc_html_e( 'Budget', 'journeyloom' ); ?></option>
                    <option value="mid-range" selected><?php esc_html_e( 'Mid-range', 'journeyloom' ); ?></option>
                    <option value="premium"><?php esc_html_e( 'Premium', 'journeyloom' ); ?></option>
                    <option value="luxury"><?php esc_html_e( 'Luxury', 'journeyloom' ); ?></option>
                </select>
            </label>
        </div>
        <div class="wptm-ai-builder__opts">
            <?php
            $ai_parts = array(
                'description' => __( 'Description', 'journeyloom' ),
                'highlights'  => __( 'Highlights', 'journeyloom' ),
                'itinerary'   => __( 'Itinerary', 'journeyloom' ),
                'inclusions'  => __( 'Includes / Excludes', 'journeyloom' ),
                'faq'         => __( 'FAQ', 'journeyloom' ),
                'facts'       => __( 'Trip facts', 'journeyloom' ),
            );
            ...
            <?php endforeach; ?>
            <label class="wptm-ai-chip wptm-ai-chip--danger"><input type="checkbox" class="wptm-ai-replace" checked> <?php esc_html_e( 'Replace existing', 'journeyloom' ); ?></label>
        </div>
        <div class="wptm-ai-builder__foot">
            <button type="button" class="button button-primary wptm-ai-generate-trip">
                <span class="dashicons dashicons-superhero-alt"></span> <?php esc_html_e( 'Generate Full Trip', 'journeyloom' ); ?>
            </button>
...
<div class="wptm-panel-intro">
    ...
    <p><?php esc_html_e( 'Key facts about this trip — shown in the summary box and search filters.', 'journeyloom' ); ?></p>
</div>
<div class="wptm-meta-field" style="margin-bottom:16px;">
    <label style="display:flex;align-items:center;gap:8px;cursor:pointer;">
        ...
        <strong><?php esc_html_e( 'Featured trip', 'journeyloom' ); ?></strong>
    </label>
    <p class="description"><?php esc_html_e( 'Show a “Featured” ribbon on this trip’s card across listings.', 'journeyloom' ); ?></p>
</div>
<div class="wptm-meta-grid">
    <div class="wptm-meta-field">
        <label><?php esc_html_e( 'Duration', 'journeyloom' ); ?></label>
    ...
    <div class="wptm-meta-field">
        <label><?php esc_html_e( 'Group Size', 'journeyloom' ); ?></label>
        <div class="wptm-inline">
            <input type="number" name="wptm_group_min" value="<?php echo esc_attr( $fields['group_min'] ); ?>" min="1" placeholder="<?php esc_attr_e( 'Min', 'journeyloom' ); ?>">
            <span class="wptm-inline__sep">—</span>
            <input type="number" name="wptm_group_max" value="<?php echo esc_attr( $fields['group_max'] ); ?>" min="1" placeholder="<?php esc_attr_e( 'Max', 'journeyloom' ); ?>">
        </div>
    </div>
    <div class="wptm-meta-field">
    ...
    <div class="wptm-meta-field">
        <label><?php esc_html_e( 'Minimum Age', 'journeyloom' ); ?></label>
        ...
        <div class="wptm-repeater wptm-list-repeater">
            ...
            <div class="wptm-repeater-items">
                ...
                <div class="wptm-repeater-item"><div class="wptm-list-row">
                    ...
                    <button type="button" class="wptm-remove-item button-link" aria-label="<?php esc_attr_e( 'Remove', 'journeyloom' ); ?>"><span class="dashicons dashicons-trash"></span></button>
                </div></div>
                <?php endforeach; ?>
            </div>
    ...
    <div class="wptm-meta-field wptm-full">
        <label><?php esc_html_e( 'Highlights', 'journeyloom' ); ?></label>
        <?php $wptm_list_repeater( 'wptm_highlights', wptm_to_list( $fields['highlights'] ), __( 'e.g. Sunset over the valley', 'journeyloom' ), __( 'Add Highlight', 'journeyloom' ) ); ?>
    </div>
    <div class="wptm-meta-field wptm-full">
        <label><?php esc_html_e( "What's Included", 'journeyloom' ); ?></label>
        <?php $wptm_list_repeater( 'wptm_includes', wptm_to_list( $fields['includes'] ), __( 'e.g. Airport transfers', 'journeyloom' ), __( 'Add Item', 'journeyloom' ) ); ?>
    </div>
    <div class="wptm-meta-field wptm-full">
        <label><?php esc_html_e( "What's Excluded", 'journeyloom' ); ?></label>
        <?php $wptm_list_repeater( 'wptm_excludes', wptm_to_list( $fields['excludes'] ), __( 'e.g. International flights', 'journeyloom' ), __( 'Add Item', 'journeyloom' ) ); ?>
    </div>
</div>
