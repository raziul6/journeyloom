...
<div class="wrap wptm-admin-wrap">
    <h1><?php esc_html_e( 'Reports', 'journeyloom' ); ?></h1>
    <div class="wptm-card">
        <h3><?php esc_html_e( 'Monthly Revenue', 'journeyloom' ); ?></h3>
        <table class="wp-list-table widefat fixed striped">
            <thead><tr><th><?php esc_html_e('Month','journeyloom');?></th><th><?php esc_html_e('Bookings','journeyloom');?></th><th><?php esc_html_e('Revenue','journeyloom');?></th></tr></thead>
            <tbody>
            <?php if(empty($monthly)):?><tr><td colspan="3"><?php esc_html_e('No data.','journeyloom');?></td></tr>
