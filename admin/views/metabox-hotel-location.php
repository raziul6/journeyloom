...
<div class="wptm-panel-intro">
    ...
    <p><?php esc_html_e( 'Paste a map embed code for the best result, or enter address & coordinates.', 'journeyloom' ); ?></p>
</div>
<div class="wptm-meta-grid">
    <div class="wptm-meta-field wptm-full">
        ...
        <textarea name="wptm_hotel_map_embed" rows="3" class="widefat" placeholder="<?php esc_attr_e( '<iframe src=&quot;https://www.google.com/maps/embed?pb=...&quot; ...></iframe>', 'journeyloom' ); ?>"><?php echo esc_textarea( $fields['map_embed'] ); ?></textarea>
    ...
    <div class="wptm-meta-field wptm-full">
        ...
        <input type="text" name="wptm_hotel_address" value="<?php echo esc_attr( $fields['address'] ); ?>" class="widefat" placeholder="<?php esc_attr_e( 'Street address', 'journeyloom' ); ?>">
    </div>
    <div class="wptm-meta-field">
        <label><?php esc_html_e( 'City', 'journeyloom' ); ?></label>
        <input type="text" name="wptm_hotel_city" value="<?php echo esc_attr( $fields['city'] ); ?>" class="widefat">
    </div>
    <div class="wptm-meta-field">
        <label><?php esc_html_e( 'Country', 'journeyloom' ); ?></label>
