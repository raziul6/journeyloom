...
<div class="wptm-panel-intro">
    ...
    <p><?php esc_html_e( 'Core hotel information shown across listings and booking pages.', 'journeyloom' ); ?></p>
</div>
<div class="wptm-meta-field" style="margin-bottom:16px;">
    <label style="display:flex;align-items:center;gap:8px;cursor:pointer;">
        ...
        <strong><?php esc_html_e( 'Featured hotel', 'journeyloom' ); ?></strong>
    </label>
    <p class="description"><?php esc_html_e( 'Show a “Featured” ribbon on this hotel’s card across listings.', 'journeyloom' ); ?></p>
</div>
<div class="wptm-meta-grid">
    <div class="wptm-meta-field">
        <label><?php esc_html_e( 'Star Rating', 'journeyloom' ); ?></label>
    ...
    <div class="wptm-meta-field">
        <label><?php esc_html_e( 'Phone', 'journeyloom' ); ?></label>
    ...
    <div class="wptm-meta-field wptm-full">
        <p class="wptm-field-hint" style="margin:0;display:flex;align-items:center;gap:6px;">
            ...
            <?php esc_html_e( 'Add the hotel’s facilities in the “Facilities” tab — they display with icons on the hotel page.', 'journeyloom' ); ?>
        </p>
    </div>
</div>
