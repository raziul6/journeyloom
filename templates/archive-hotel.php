...
<div class="wptm-archive-wrap">
    <div class="wptm-archive-hero wptm-archive-hero--hotel">
        ...
        <p class="wptm-archive-hero__sub"><?php esc_html_e( 'Find the perfect accommodation for your next adventure.', 'wp-travel-machine' ); ?></p>
    </div>
    ...
    <div class="wptm-archive-body">
        ...
        <?php else : ?>
            <div class="wptm-grid wptm-grid-3 wptm-search-results">
                <p class="wptm-no-results"><?php esc_html_e( 'No hotels found. Try adjusting your filters.', 'wp-travel-machine' ); ?></p>
            </div>
        <?php endif; ?>
    </div>
</div>
